...
const Header: React.FC = () => {
  ...
  return (
    <div className="relative flex w-full items-center justify-between px-5 py-4 bg-black bg-opacity-70 text-white md:px-10">
      <Head>
      ...
      <ul className={`fixed top-0 left-0 z-50 h-full w-full flex flex-col items-center justify-center bg-black bg-opacity-70 text-lg transition-transform transform ${isMenuOpen ? "translate-y-0" : "-translate-y-full"} md:relative md:top-auto md:left-auto md:h-auto md:w-auto md:flex-row md:bg-transparent md:text-xs md:translate-y-0`}>
...
<div className="mt-5 md:mt-0 md:ml-6">
  <Link href="/login" passHref
    className="flex items-center gap-2"> {/* Add flex container and gap */}
